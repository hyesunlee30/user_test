...
<body>
<center><font size=5><b><br>Phone Add<br></b></font></center>
<div class="container col-md-3">
    <form method="POST" id="newForm" name="newForm">
          <div class="form-group">
            <label for="exampleFormControlInput1">Id</label>
            <input type="text" class="form-control" id="id" name="id" value="${user.id}" readonly placeholder="자동부여">
          </div>
         <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="PhoneNumber" name="PhoneNumber" value="" placeholder="새로운 폰번호를 입력하세요."   >
        </div>
        <center>        	

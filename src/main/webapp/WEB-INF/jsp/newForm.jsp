...
<div class="container col-md-3">
    <form method="POST" id="newForm" name="newForm">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="id" name="id" readonly placeholder="자동부여">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="PhoneNumber" name="PhoneNumber" placeholder="폰번호를 입력하세요."   >
        </div>
        <center>        	
			 <button onClick='fn_addtoGongji1()' class="btn btn-info" >추가</button>
